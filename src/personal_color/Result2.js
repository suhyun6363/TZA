              ...
              <div className="color-descriptions">
                {analysisData.personal_color.startsWith("N-") ? (
                  <p>
                    ...
                    <br /> 더 자유롭게 여러 스타일을 시도할 수 있어요. <br />
                    뉴트럴 톤이지만, 당신에게 조금 더 조화로운 컬러가 있는데요,
                    바로 오른쪽에 나와 있는 계절의 톤이에요!
                  </p>
                ) : (
