...
|:----------------------------------------:|:----------------------------------------------:|
| <img src="./uploads/포토부스.png" width=250> | <img src="./uploads/tza_애플리케이션.png" width=250> |
### 주요 기능
#### 웹
+ 피부 영역 픽셀 기반 퍼스널 컬러 진단
   ...
   <br/><img src="./uploads/대표_피부색_산출.png" width=250></br>
   <br/>
   ...
   <br/><img src="./uploads/vbs_공간모델.png" width=250></br>
   <br/>
...
|:------------------------------------------:|:--------------------------------------------:|:---------------------------------------------:|:------------------------------------------------------------------------:|
| <img src="./uploads/웹_시작화면.png" width=300> | <img src="./uploads/웹_진단결과화면.png" width=300> | <img src="./uploads/웹_대표연예인화면.png" width=300> | <img src="./uploads/웹_QR코드화면.png" width=300> <br/> QR코드를 통해 앱으로 진단 결과 전송 |        
### 안드로이드 애플리케이션
| **런처 화면**                                  | **회원가입 화면**                                  | **로그인 화면**                                  |                 **메인/홈 화면**                  |            **퍼스널 컬러 맞춤 추천 제품 화면**            |                **종합 랭킹 화면**                 | **립/블러셔 대표 색상**                                                                          |                 **가상 메이크업 화면**                 | **마이페이지 화면**                                  |
|--------------------------------------------|----------------------------------------------|---------------------------------------------|:--------------------------------------------:|:--------------------------------------------:|:-------------------------------------------:|------------------------------------------------------------------------------------------|:----------------------------------------------:|-----------------------------------------------|
| <img src="./uploads/앱_런처화면.png" width=200> | <img src="./uploads/앱_회원가입화면.png" width=200> | <img src="./uploads/앱_로그인화면.png" width=200> | <img src="./uploads/앱_메인_홈화면.gif" width=200> | <img src="./uploads/앱_추천제품화면.gif" width=200> | <img src="./uploads/앱_종합랭킹화면.gif" width=200> | <img src="./uploads/앱_립.gif" width=300><br><img src="./uploads/앱_블러셔.gif" width=300><br> | <img src="./uploads/앱_가상메이크업화면.png" width=400> | <img src="./uploads/앱_마이페이지화면.png" width=200> |
## 팀원
___
|**안예은**|**이규빈**|                                                                                                                          **정수현**                                                                                                                          | **김희수** |
|:-----:|:-----:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:-------:|
